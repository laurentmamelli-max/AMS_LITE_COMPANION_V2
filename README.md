...
- comparaison locale côte à côte de deux vues d’une même couche, pour révéler les objets masqués par la tête sans projection ni différence géométrique trompeuse ;
