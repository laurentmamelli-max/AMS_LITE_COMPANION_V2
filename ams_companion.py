...
function closeCapture(){modalEl.hidden=true;calibrationMode=false;calibrationPoints=[];selectedObjectIndex=-1;largeEl.removeAttribute('src');overlayEl.innerHTML='';legendEl.innerHTML=''}
